// lib/screens/profile_pages.dart
...
// ---
// --- NEW WIDGET: ADMIN USER DETAILS PAGE ---
// ---
class AdminUserDetailsPage extends StatelessWidget {
  final Map<String, dynamic> user;

  const AdminUserDetailsPage({Key? key, required this.user}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final String id = user['id'] ?? 'No ID';

    return Scaffold(
      appBar: AppBar(
        title: Text(name), // Show the user's name in the app bar
      ),
      body: ListView(
        padding: const EdgeInsets.all(16.0),
        children: [
